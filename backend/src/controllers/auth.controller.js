...
export async function signup(req, res) {
  ...
  try{
    ...
    {
        return res.status(400).json({message:"Passwords must be atleast 6 characters"});
    }
    ...
    if(existingUser)
    {
        return res.status(400).json({message:"Email already exists.Please Use other email id."})
    }
